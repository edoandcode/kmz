...
public class AuthController {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<JwtResponseDto> refresh(@RequestBody JwtRefreshDto refreshDto){
        var accessJwt = this.authService.refreshAccessToken(refreshDto.getRefreshToken());
