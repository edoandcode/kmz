...
public class Producer implements UserRole{

    @Override
    public boolean can(UserAction action) {
        return switch (action) {
            case VISUALIZE_CONTENT, CREATE_PRODUCT -> true;
            default -> false;
        };
    }
    ...
    public UserAction[] can() {
        return new UserAction[]{UserAction.VISUALIZE_CONTENT, UserAction.CREATE_PRODUCT};
    }
